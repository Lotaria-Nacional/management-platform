import { FetchAllPosAvaliationUseCaseResponseDTO } from "../../dto/pos-avaliation/fetch-all-pos-avaliation.dto";
...
export class FetchAllPosAvaliationUseCase {
    ...
    async execute():Promise<FetchAllPosAvaliationUseCaseResponseDTO>{
