...
export class RegisterAgentController implements IController<IRegisterAgentRequestDTO> {
    constructor(private useCase:RegisterAgentUseCase){}

    async handle(request: HttpRequest<IRegisterAgentRequestDTO>): Promise<HttpResponse> {
