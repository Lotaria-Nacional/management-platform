...
exports.TerminalMapper = void 0;
const terminal_entity_1 = require("../../enterprise/entities/terminal.entity");
class TerminalMapper {
    static toDomain(data) {
        const { agent, created_at, id, id_reference, pin, puk, serial, sim_card } = data;
        return terminal_entity_1.Terminal.create({
            id_reference,
            pin: pin ?? undefined,
            puk: puk ?? undefined,
            serial,
    ...
    static toPersistence(data) {
        const { id_reference, pin, puk, serial, sim_card, agent_id, area_id, city_id, province_id, zone_id, } = data.toJSON();
        return {
            id_reference,
            pin,
            puk,
...
exports.TerminalMapper = TerminalMapper;
//# sourceMappingURL=terminal-mapper.js.map